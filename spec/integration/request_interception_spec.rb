...
RSpec.describe "Request interception" do
  ...
  describe "Page.set_request_interception" do
    ...
    it "should work with keep alive redirects" do
      with_test_state do |page:, server:, **|
    ...
    it "should not allow mutating request headers" do
      with_test_state do |page:, server:, **|
        page.set_request_interception(true)
        requests = []
        page.on(:request) do |request|
    ...
    it "should work with requests without networkId" do
  ...
  describe "Request.continue" do
    ...
    it "should fail if the header value is invalid" do
      with_test_state do |page:, server:, **|
        error = nil
        page.set_request_interception(true)
        page.on(:request) do |request|
  ...
  describe "Request.respond" do
    ...
    it "should allow mocking multiple headers with same key" do
      with_test_state do |page:, server:, **|
        page.set_request_interception(true)
        page.on(:request) do |request|
          request.respond(
    ...
    it "should report correct content-length header with string" do
      with_test_state do |page:, server:, **|
        page.set_request_interception(true)
    ...
    it "should report correct content-length header with buffer" do
      with_test_state do |page:, server:, **|
        page.set_request_interception(true)
    ...
    it "should report correct encoding from page when content-type is set" do
      with_test_state do |page:, server:, **|
        page.set_request_interception(true)
        page.on(:request) do |request|
          request.respond(
