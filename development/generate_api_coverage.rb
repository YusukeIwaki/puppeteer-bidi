...
def read_puppeteer_version(puppeteer_dir)
  package_json_path = puppeteer_dir.join("packages", "puppeteer-core", "package.json")
...
def generate_markdown(puppeteer_commit:, puppeteer_version:, entries:, ruby_api:)
  ...
  lines << "# API Coverage"
  lines << ""
  lines << "- Puppeteer version: `#{puppeteer_version}`"
...
puppeteer_version = read_puppeteer_version(puppeteer_dir)
