...
| `HTTPRequest.isInterceptResolutionHandled` | `Puppeteer::Bidi::HTTPRequest#is_intercept_resolution_handled` | ❌ |
| `HTTPRequest.isNavigationRequest` | `Puppeteer::Bidi::HTTPRequest#is_navigation_request` | ❌ |
