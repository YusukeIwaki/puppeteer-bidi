...
- Puppeteer version: `25.10.0`
- Puppeteer commit: `88b517ab3beb4a237b541cd18ada98ba43de71a7`
- Generated by: `development/generate_api_coverage.rb`
- Coverage: `204/300` (`68.00%`)

## Browser (Puppeteer::Bidi::Browser)

| Node.js | Ruby | Supported |
| --- | --- | :---: |
| `Browser.[asyncDisposeSymbol]` | `Puppeteer::Bidi::Browser#[async_dispose_symbol]` | ❌ |
| `Browser.[disposeSymbol]` | `Puppeteer::Bidi::Browser#[dispose_symbol]` | ❌ |
...
| `Browser.getPWAState` | `Puppeteer::Bidi::Browser#get_pwa_state` | ❌ |
...
| `Browser.installPWA` | `Puppeteer::Bidi::Browser#install_pwa` | ❌ |
| `Browser.launchPWA` | `Puppeteer::Bidi::Browser#launch_pwa` | ❌ |
...
| `Browser.uninstallPWA` | `Puppeteer::Bidi::Browser#uninstall_pwa` | ❌ |
...
| Node.js | Ruby | Supported |
| --- | --- | :---: |
| `BrowserContext.[asyncDisposeSymbol]` | `Puppeteer::Bidi::BrowserContext#[async_dispose_symbol]` | ❌ |
| `BrowserContext.[disposeSymbol]` | `Puppeteer::Bidi::BrowserContext#[dispose_symbol]` | ❌ |
...
| Node.js | Ruby | Supported |
| --- | --- | :---: |
| `Dialog.accept` | `Puppeteer::Bidi::Dialog#accept` | ✅ |
| `Dialog.defaultValue` | `Puppeteer::Bidi::Dialog#default_value` | ✅ |
| `Dialog.dismiss` | `Puppeteer::Bidi::Dialog#dismiss` | ✅ |
| `Dialog.handled` | `Puppeteer::Bidi::Dialog#handled?` | ✅ |
| `Dialog.message` | `Puppeteer::Bidi::Dialog#message` | ✅ |
| `Dialog.type` | `Puppeteer::Bidi::Dialog#type` | ✅ |
...
| Node.js | Ruby | Supported |
| --- | --- | :---: |
| `JSHandle.[asyncDisposeSymbol]` | `Puppeteer::Bidi::JSHandle#[async_dispose_symbol]` | ❌ |
| `JSHandle.[disposeSymbol]` | `Puppeteer::Bidi::JSHandle#[dispose_symbol]` | ❌ |
...
| `Page.[asyncDisposeSymbol]` | `Puppeteer::Bidi::Page#[async_dispose_symbol]` | ❌ |
| `Page.[disposeSymbol]` | `Puppeteer::Bidi::Page#[dispose_symbol]` | ❌ |
...
| `Page.captureHeapSnapshot` | `Puppeteer::Bidi::Page#capture_heap_snapshot` | ❌ |
...
| `Page.record` | `Puppeteer::Bidi::Page#record` | ✅ |
...
| `PuppeteerNode.setFollowSymlinks` | `Puppeteer::Bidi.set_follow_symlinks` | ✅ |
