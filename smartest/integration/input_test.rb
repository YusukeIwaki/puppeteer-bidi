...
test("[input tests][ElementHandle.uploadFile] should upload the file") do |page:, server:|
  ...
  file_to_upload = File.expand_path("../../spec/assets/file-to-upload.txt", __dir__)
...
test("[input tests][ElementHandle.uploadFile] should read the file") do |page:, server:|
  page.goto("#{server.prefix}/input/fileupload.html")
  input = page.query_selector("input")
  input.evaluate(<<~JS)
    (e) => {
...
test("[input tests][Page.waitForFileChooser] should work when file input is attached to DOM") do |page:|
...
test("[input tests][Page.waitForFileChooser] should work when file input is attached to DOM using JavaScript") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][Page.waitForFileChooser] should work when file input is not attached to DOM") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][Page.waitForFileChooser] should respect timeout") do |page:|
  expect {
...
test("[input tests][Page.waitForFileChooser] should respect default timeout when there is no custom timeout") do |page:|
...
test("[input tests][Page.waitForFileChooser] should prioritize exact timeout over default timeout") do |page:|
...
test("[input tests][Page.waitForFileChooser] should work with no timeout") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][Page.waitForFileChooser] should return the same file chooser when there are many watchdogs simultaneously") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.accept] should accept single file") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.accept] should be able to read selected file") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.accept] should be able to reset selected files with empty file list") do |page:|
  if linux?
    if headless_mode?
...
test("[input tests][FileChooser.accept] should not accept multiple files for single-file input") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?

  page.set_content('<input type="file" />')
  file_to_upload = File.expand_path("../../spec/assets/file-to-upload.txt", __dir__)
  pptr_png = File.expand_path("../../spec/assets/pptr.png", __dir__)
...
test("[input tests][FileChooser.accept] should succeed even for non-existent files") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.accept] should error on read of non-existent files") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.accept] should fail when accepting file chooser twice") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.cancel] should cancel dialog") do |page:|
  if linux?
    if headless_mode?
      skip "Firefox crashes in headless mode on Linux"
    else
...
test("[input tests][FileChooser.cancel] should fail when canceling file chooser twice") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test("[input tests][FileChooser.isMultiple] should work for single file pick") do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test('[input tests][FileChooser.isMultiple] should work for "multiple"') do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
...
test('[input tests][FileChooser.isMultiple] should work for "webkitdirectory"') do |page:|
  skip "Firefox crashes in headless mode on Linux" if headless_mode? && linux?
