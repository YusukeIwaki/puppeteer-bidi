...
require "test_helper"
    ...
    test(['ElementHandle specs', 'ElementHandle.boundingBox', 'should work'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.boundingBox', 'should handle nested frames'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.boundingBox', 'should return null for invisible elements'].join(" ")) do |page:|
      page.set_content('<div style="display:none">hi</div>')
      element = page.query_selector('div')
      expect(element.bounding_box).to be_nil
    end

    test(['ElementHandle specs', 'ElementHandle.boundingBox', 'should force a layout'].join(" ")) do |page:|
      page.set_viewport(width: 500, height: 500)
    ...
    test(['ElementHandle specs', 'ElementHandle.boundingBox', 'should work with SVG nodes'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.boxModel', 'should work'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.boxModel', 'should return null for invisible elements'].join(" ")) do |page:|
      page.set_content('<div style="display:none">hi</div>')
      element = page.query_selector('div')
      expect(element.box_model).to be_nil
    end

    test(['ElementHandle specs', 'ElementHandle.boxModel', 'should correctly compute box model with offsets'].join(" ")) do |page:|
      border = 10
      padding = 11
      margin = 12
      width = 200
    ...
    test(['ElementHandle specs', 'ElementHandle.contentFrame', 'should work'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.click', 'should return Point data'].join(" ")) do |page:|
      page.evaluate(<<~JS)
        () => {
    ...
    test(['ElementHandle specs', 'ElementHandle.click', 'should work for Shadow DOM v1'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.click', 'should throw for detached nodes'].join(" ")) do |page:, server:|
      page.goto("#{server.prefix}/input/button.html")
      button = page.query_selector('button')
    ...
    test(['ElementHandle specs', 'ElementHandle.click', 'should throw for hidden nodes'].join(" ")) do |page:, server:|
      page.goto("#{server.prefix}/input/button.html")
      button = page.query_selector('button')
    ...
    test(['ElementHandle specs', 'ElementHandle.click', 'should throw for recursively hidden nodes'].join(" ")) do |page:, server:|
      page.goto("#{server.prefix}/input/button.html")
      button = page.query_selector('button')
    ...
    test(['ElementHandle specs', 'ElementHandle.click', 'should throw for <br> elements'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.touchStart', 'should work'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.touchMove', 'should work'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.touchEnd', 'should work'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.clickablePoint', 'should work'].join(" ")) do |page:|
      page.evaluate(<<~JS)
        () => {
          document.body.style.padding = '0';
          document.body.style.margin = '0';
    ...
    test(['ElementHandle specs', 'ElementHandle.clickablePoint', 'should not work if the click box is not visible'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.clickablePoint', 'should work for iframes'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'Element.waitForSelector', 'should wait correctly with waitForSelector on an element'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'Element.waitForSelector', 'should wait correctly with waitForSelector and xpath on an element'].join(" ")) do |page:|
      page.set_content(<<~HTML)
        <div id="el1">
          el1
          <div id="el2">el2</div>
    ...
    test(['ElementHandle specs', 'ElementHandle.hover', 'should work'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.isIntersectingViewport', 'should work'].join(" ")) do |page:, server:|
    ...
    test(['ElementHandle specs', 'ElementHandle.isIntersectingViewport', 'should work with threshold'].join(" ")) do |page:, server:|
      page.goto("#{server.prefix}/offscreenbuttons.html")
    ...
    test(['ElementHandle specs', 'ElementHandle.toElement', 'should work'].join(" ")) do |page:|
    ...
    test(['ElementHandle specs', 'ElementHandle.toElement', 'should throw if element does not match'].join(" ")) do |page:|
      page.set_content('<div class="foo">Foo1</div>')
      element = page.query_selector('.foo')
      expect {
