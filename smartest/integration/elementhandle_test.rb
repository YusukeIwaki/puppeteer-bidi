...
test("[ElementHandle specs][ElementHandle.boundingBox] should work") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.boundingBox] should handle nested frames") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.boundingBox] should return null for invisible elements") do |page:|
  page.set_content('<div style="display:none">hi</div>')
  element = page.query_selector("div")
  expect(element.bounding_box).to be_nil
end

test("[ElementHandle specs][ElementHandle.boundingBox] should force a layout") do |page:|
  page.set_viewport(width: 500, height: 500)
...
test("[ElementHandle specs][ElementHandle.boundingBox] should work with SVG nodes") do |page:|
...
test("[ElementHandle specs][ElementHandle.boxModel] should work") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.boxModel] should return null for invisible elements") do |page:|
  page.set_content('<div style="display:none">hi</div>')
  element = page.query_selector("div")
  expect(element.box_model).to be_nil
end

test("[ElementHandle specs][ElementHandle.boxModel] should correctly compute box model with offsets") do |page:|
  border = 10
  padding = 11
  margin = 12
  width = 200
...
test("[ElementHandle specs][ElementHandle.contentFrame] should work") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.isVisible and ElementHandle.isHidden] should work") do |page:|
...
test("[ElementHandle specs][ElementHandle.click] should work") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.click] should return Point data") do |page:|
  page.evaluate(<<~JS)
    () => {
...
test("[ElementHandle specs][ElementHandle.click] should work for Shadow DOM v1") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.click] should not work for TextNodes") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
...
test("[ElementHandle specs][ElementHandle.click] should throw for detached nodes") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  button = page.query_selector("button")
...
test("[ElementHandle specs][ElementHandle.click] should throw for hidden nodes") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  button = page.query_selector("button")
...
test("[ElementHandle specs][ElementHandle.click] should throw for recursively hidden nodes") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  button = page.query_selector("button")
...
test("[ElementHandle specs][ElementHandle.click] should throw for <br> elements") do |page:|
...
test("[ElementHandle specs][ElementHandle.touchStart] should work") do |page:|
...
test("[ElementHandle specs][ElementHandle.touchMove] should work") do |page:|
...
test("[ElementHandle specs][ElementHandle.touchEnd] should work") do |page:|
...
test("[ElementHandle specs][ElementHandle.clickablePoint] should work") do |page:|
  page.evaluate(<<~JS)
    () => {
      document.body.style.padding = '0';
      document.body.style.margin = '0';
...
test("[ElementHandle specs][ElementHandle.clickablePoint] should not work if the click box is not visible") do |page:|
...
test("[ElementHandle specs][ElementHandle.clickablePoint] should work for iframes") do |page:|
...
test("[ElementHandle specs][Element.waitForSelector] should wait correctly with waitForSelector on an element") do |page:|
...
test("[ElementHandle specs][Element.waitForSelector] should wait correctly with waitForSelector and xpath on an element") do |page:|
  page.set_content(<<~HTML)
    <div id="el1">
      el1
      <div id="el2">el2</div>
...
test("[ElementHandle specs][ElementHandle.hover] should work") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.isIntersectingViewport] should work") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.isIntersectingViewport] should work with threshold") do |page:, server:|
  page.goto("#{server.prefix}/offscreenbuttons.html")
...
test("[ElementHandle specs][ElementHandle.isIntersectingViewport] should work with threshold of 1") do |page:, server:|
...
test("[ElementHandle specs][ElementHandle.isIntersectingViewport] should work with svg elements") do |page:, server:|
...
test("[ElementHandle specs][Custom queries] should register and unregister") do |page:|
...
test("[ElementHandle specs][Custom queries] should throw with invalid query names") do
  skip "Custom query handlers not yet fully implemented"
...
test("[ElementHandle specs][Custom queries] should work for multiple elements") do |page:|
  skip "Custom query handlers not yet fully implemented"
...
test("[ElementHandle specs][ElementHandle.toElement] should work") do |page:|
...
test("[ElementHandle specs][ElementHandle.toElement] should throw if element does not match") do |page:|
  page.set_content('<div class="foo">Foo1</div>')
  element = page.query_selector(".foo")
  expect {
...
test("[ElementHandle specs][ElementHandle.dispose] should dispose the element handle") do |page:|
