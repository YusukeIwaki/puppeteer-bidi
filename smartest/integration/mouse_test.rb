...
require "test_helper"
  ...
  test(['Mouse', 'should click the document'].join(" ")) do |page:|
    page.evaluate(<<~JS)
      () => {
  ...
  test(['Mouse', 'should resize the textarea'].join(" ")) do |page:, server:|
  ...
  test(['Mouse', 'should select the text with mouse'].join(" ")) do |page:, server:|
  ...
  test(['Mouse', 'should trigger hover state'].join(" ")) do |page:, server:|
  ...
  test(['Mouse', 'should trigger hover state with removed window.Node'].join(" ")) do |page:, server:|
    page.goto("#{server.prefix}/input/scrollable.html")
  ...
  test(['Mouse', 'should set modifier keys on click'].join(" ")) do |page:, server:|
    page.goto("#{server.prefix}/input/scrollable.html")
    page.evaluate(<<~JS)
      () => {
  ...
  test(['Mouse', 'should send mouse wheel events'].join(" ")) do |page:, server:|
  ...
  test(['Mouse', 'should set ctrlKey on the wheel event'].join(" ")) do |page:, server:|
  ...
  test(['Mouse', 'should work with mobile viewports and cross process navigations'].join(" ")) do |page:, server:|
  ...
  test(['Mouse', 'should not throw if buttons are pressed twice'].join(" ")) do |page:, server:|
    page.goto(server.empty_page)
  ...
  test(['Mouse', 'should not throw if clicking in parallel'].join(" ")) do |page:, server:|
    page.goto(server.empty_page)
  ...
  test(['Mouse', 'should reset properly'].join(" ")) do |page:, server:|
    page.goto(server.empty_page)
  ...
  test(['Mouse', 'should evaluate before mouse event'].join(" ")) do |page:, server:|
    page.goto(server.empty_page)
