...
test("[Screenshot][Page.screenshot] should work") do |page:, server:|
...
test("[Screenshot][Page.screenshot] should clip rect") do |page:, server:|
  page.set_viewport(width: 500, height: 500)
  page.goto("#{server.prefix}/grid.html")
  screenshot = page.screenshot(
    clip: {
...
test("[Screenshot][Page.screenshot] should get screenshot bigger than the viewport") do |page:, server:|
...
test('[Screenshot][Page.screenshot] should clip clip bigger than the viewport without "captureBeyondViewport"') do |page:, server:|
  page.set_viewport(width: 50, height: 50)
  page.goto("#{server.prefix}/grid.html")
  screenshot = page.screenshot(
...
test("[Screenshot][Page.screenshot] should run in parallel") do |page:, server:|
  page.set_viewport(width: 500, height: 500)
  page.goto("#{server.prefix}/grid.html")
...
test("[Screenshot][Page.screenshot] should take fullPage screenshots") do |page:, server:|
  page.set_viewport(width: 500, height: 500)
  page.goto("#{server.prefix}/grid.html")
...
test("[Screenshot][Page.screenshot] should take fullPage screenshots without captureBeyondViewport") do |page:, server:|
  page.set_viewport(width: 500, height: 500)
  page.goto("#{server.prefix}/grid.html")
  screenshot = page.screenshot(
    full_page: true,
...
test("[Screenshot][Page.screenshot] should run in parallel in multiple pages") do |page:, server:, context:|
  n = 2
  pages = (0...n).map do
...
test("[Screenshot][Page.screenshot] should work with odd clip size on Retina displays") do |page:|
...
test("[Screenshot][Page.screenshot] should return base64") do |page:, server:|
  page.set_viewport(width: 500, height: 500)
  page.goto("#{server.prefix}/grid.html")
  screenshot = page.screenshot
...
test("[Screenshot][Page.screenshot] should take fullPage screenshots when defaultViewport is null") do |page:, server:|
  page.goto("#{server.prefix}/grid.html")
  screenshot = page.screenshot(full_page: true)

  # Screenshot should be a base64 string
  expect(screenshot).to be_a(String)
  expect(screenshot.length).to be_greater_than(0)
end

test("[Screenshot][Page.screenshot] should restore to original viewport size after taking fullPage screenshots when defaultViewport is null") do |page:, server:|
...
test("[Screenshot][ElementHandle.screenshot] should work") do |page:, server:|
  page.set_viewport(width: 500, height: 500)
  page.goto("#{server.prefix}/grid.html")
...
test("[Screenshot][ElementHandle.screenshot] should take into account padding and border") do |page:|
  page.set_viewport(width: 500, height: 500)
...
test("[Screenshot][ElementHandle.screenshot] should capture full element when larger than viewport") do |page:|
  page.set_viewport(width: 500, height: 500)
  page.set_content(<<~HTML)
    something above
    <style>
...
test("[Screenshot][ElementHandle.screenshot] should scroll element into view") do |page:|
  page.set_viewport(width: 500, height: 500)
  page.set_content(<<~HTML)
    something above
    <style>
...
test("[Screenshot][ElementHandle.screenshot] should work with a rotated element") do |page:|
  page.set_viewport(width: 500, height: 500)
  page.set_content(<<~HTML)
    <style>
...
test("[Screenshot][ElementHandle.screenshot] should fail if element has 0 height") do |page:|
  page.set_viewport(width: 500, height: 500)
...
test("[Screenshot][ElementHandle.screenshot] should fail if element has 0 width") do |page:|
  page.set_viewport(width: 500, height: 500)
...
test("[Screenshot][ElementHandle.screenshot] should work for an element with fractional dimensions") do |page:|
  page.set_viewport(width: 500, height: 500)
...
test("[Screenshot][ElementHandle.screenshot] should work for an element with an offset") do |page:|
  page.set_viewport(width: 500, height: 500)
  page.set_content(<<~HTML)
    <style>
      body { height: 1000px; margin: 0; }
...
test("[Screenshot][ElementHandle.screenshot] should work with element clip") do |page:|
  page.set_viewport(width: 500, height: 500)
  page.set_content(<<~HTML)
    something above
    <style>
