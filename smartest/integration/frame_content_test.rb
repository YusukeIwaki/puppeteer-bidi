...
require "test_helper"
    ...
    test(['Frame.content', '#content', 'should return the full HTML contents of the frame'].join(" ")) do |page:, server:|
    ...
    test(['Frame.content', '#content', 'should include the DOCTYPE'].join(" ")) do |page:, server:|
      page.goto(server.empty_page)
    ...
    test(['Frame.content', '#content', 'should work with nested HTML structure'].join(" ")) do |page:, server:|
      page.goto(server.empty_page)
    ...
    test(['Frame.content', '#content', 'should work for iframes'].join(" ")) do |page:, server:|
    ...
    test(['Frame.content', '#content', 'should throw for detached frames'].join(" ")) do |page:, server:|
    ...
    test(['Frame.content', '#content', 'should return empty-ish content for blank page'].join(" ")) do |page:, server:|
