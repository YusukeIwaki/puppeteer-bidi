...
test("[Keyboard][Keyboard.type] should type into a textarea") do |page:|
  page.evaluate(<<~JS)
    () => {
...
test("[Keyboard][Keyboard.type] should move with the arrow keys") do |page:, server:|
...
test("[Keyboard][Keyboard.type] should trigger commands of keyboard shortcuts") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
...
test("[Keyboard][Keyboard.type] should trigger commands of keyboard shortcuts with commands option") do |page:, server:|
...
test("[Keyboard][Keyboard.type] should send a character with ElementHandle.press") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
...
test("[Keyboard][Keyboard.type] ElementHandle.press should not support |text| option") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
  textarea = page.query_selector("textarea")
...
test("[Keyboard][Keyboard.type] should send a character with sendCharacter") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
  page.focus("textarea")
...
test("[Keyboard][Keyboard.type] should send a character with sendCharacter in iframe") do |page:, server:|
...
test("[Keyboard][Keyboard.type] should report shiftKey") do |page:, server:|
...
test("[Keyboard][Keyboard.type] should report multiple modifiers") do |page:, server:|
  page.goto("#{server.prefix}/input/keyboard.html")
  keyboard = page.keyboard
...
test("[Keyboard][Keyboard.type] should send proper codes while typing") do |page:, server:|
  page.goto("#{server.prefix}/input/keyboard.html")
...
test("[Keyboard][Keyboard.type] should send proper codes while typing with shift") do |page:, server:|
  page.goto("#{server.prefix}/input/keyboard.html")
...
test("[Keyboard][Keyboard.type] should not type canceled events") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
  page.focus("textarea")
...
test("[Keyboard][Keyboard.type] should specify repeat property") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
  page.focus("textarea")
...
test("[Keyboard][Keyboard.type] should type all kinds of characters") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
  page.focus("textarea")
...
test("[Keyboard][Keyboard.type] should specify location") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
...
test("[Keyboard][Keyboard.type] should throw on unknown keys") do |page:|
  expect {
    page.keyboard.press("NotARealKey")
  }.to raise_error(/Unknown key: "NotARealKey"/)
end

test("[Keyboard][Keyboard.type] should type emoji") do |page:, server:|
  page.goto("#{server.prefix}/input/textarea.html")
...
test("[Keyboard][Keyboard.type] should type emoji into an iframe") do |page:, server:|
  page.goto(server.empty_page)
...
test("[Keyboard][Keyboard.type] should press the meta key") do |page:|
  skip "Meta key only available on darwin" unless RUBY_PLATFORM.include?("darwin")
