...
test("[Page.click] should click the button") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  page.click("button")
  expect(page.evaluate("() => globalThis.result")).to eq("Clicked")
end

test("[Page.click] should click svg") do |page:|
...
test("[Page.click] should click the button if window.Node is removed") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
...
test("[Page.click] should click on a span with an inline element inside") do |page:|
  page.set_content(<<~HTML)
    <style>
      span::before {
        content: 'q';
...
test("[Page.click] should not throw UnhandledPromiseRejection when page closes") do |page:|
...
test("[Page.click] should click the button after navigation") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  page.click("button")
  page.goto("#{server.prefix}/input/button.html")
  page.click("button")
...
test("[Page.click] should click with disabled javascript") do |page:, server:|
...
test("[Page.click] should scroll and click with disabled javascript") do |page:, server:|
  # Firefox does not yet support browsingContext.setScriptingEnabled BiDi command
  pending "browsingContext.setScriptingEnabled not supported by Firefox yet"
...
test("[Page.click] should click when one of inline box children is outside of viewport") do |page:|
  page.set_content(<<~HTML)
    <style>
      i {
        position: absolute;
...
test("[Page.click] should select the text by triple clicking") do |page:, server:|
...
test("[Page.click] should click offscreen buttons") do |page:, server:|
...
test("[Page.click] should click half-offscreen elements") do |page:|
  page.set_content(<<~HTML)
    <!DOCTYPE html>
    <style>
...
test("[Page.click] should click wrapped links") do |page:, server:|
  page.goto("#{server.prefix}/wrappedlink.html")
  page.click("a")
  expect(page.evaluate("() => globalThis.__clicked")).to eq(true)
end

test("[Page.click] should click on checkbox input and toggle") do |page:, server:|
...
test("[Page.click] should click on checkbox label and toggle") do |page:, server:|
  page.goto("#{server.prefix}/input/checkbox.html")
  expect(page.evaluate("() => globalThis.result.check")).to be_nil
...
test("[Page.click] should fail to click a missing button") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  expect {
...
test("[Page.click] should not hang with touch-enabled viewports") do |page:|
...
test("[Page.click] should scroll and click the button") do |page:, server:|
...
test("[Page.click] should double click the button") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  page.evaluate(<<~JS)
    () => {
...
test("[Page.click] should double click multiple times") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  page.evaluate(<<~JS)
    () => {
      globalThis.count = 0;
...
test("[Page.click] should click a partially obscured button") do |page:, server:|
  page.goto("#{server.prefix}/input/button.html")
  page.evaluate(<<~JS)
    () => {
      const button = document.querySelector('button');
...
test("[Page.click] should click the button with fixed position inside an iframe") do |page:, server:|
  skip "Frame support not yet implemented"
...
test("[Page.click] should click the button with deviceScaleFactor set") do |page:, server:|
  skip "Frame support not yet implemented"
