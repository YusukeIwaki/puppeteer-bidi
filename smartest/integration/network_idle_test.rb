...
test("[Page#wait_for_network_idle] waits for network to be idle") do |page:, server:|
  # Navigate to a page
...
test("[Page#wait_for_network_idle] waits for network idle after triggering requests") do |page:, server:|
  page.goto("#{server.prefix}/networkidle.html")
...
test("[Page#wait_for_network_idle] wait_for_navigation with networkidle0") do |page:, server:|
...
test("[Page#wait_for_network_idle] wait_for_navigation with networkidle2") do |page:, server:|
...
test("[Page#wait_for_network_idle] wait_for_navigation with array of wait conditions") do |page:, server:|
