...
test("[QueryHandler][Text selectors][in Page] should query existing element") do |page:|
...
test("[QueryHandler][Text selectors][in Page] should return empty array for non-existing element") do |page:|
  expect(page.query_selector("text/test")).to be_nil
  expect(page.query_selector_all("text/test").length).to eq(0)
end

test("[QueryHandler][Text selectors][in Page] should return first element") do |page:|
...
test("[QueryHandler][Text selectors][in Page] should return multiple elements") do |page:|
...
test("[QueryHandler][Text selectors][in Page] should pierce shadow DOM") do |page:|
  page.evaluate(<<~JS)
    () => {
...
test("[QueryHandler][Text selectors][in Page] should query deeply nested text") do |page:|
...
test("[QueryHandler][Text selectors][in Page] should query inputs") do |page:|
...
test("[QueryHandler][Text selectors][in Page] should not query radio") do |page:|
  page.set_content('<radio value="a"></radio>')

  expect(page.query_selector("text/a")).to be_nil
end

test("[QueryHandler][Text selectors][in Page] should query text spanning multiple elements") do |page:|
...
test("[QueryHandler][Text selectors][in Page] should clear caches") do |page:|
  page.set_content(<<~HTML)
...
test("[QueryHandler][Text selectors][in ElementHandles] should query existing element") do |page:|
...
test("[QueryHandler][Text selectors][in ElementHandles] should return null for non-existing element") do |page:|
...
test("[QueryHandler][XPath selectors][in Page] should query existing element") do |page:|
  page.set_content("<section>test</section>")
...
test("[QueryHandler][XPath selectors][in Page] should return empty array for non-existing element") do |page:|
...
test("[QueryHandler][XPath selectors][in Page] should return first element") do |page:|
...
test("[QueryHandler][XPath selectors][in Page] should return multiple elements") do |page:|
...
test("[QueryHandler][XPath selectors][in ElementHandles] should query existing element") do |page:|
...
test("[QueryHandler][XPath selectors][in ElementHandles] should return null for non-existing element") do |page:|
