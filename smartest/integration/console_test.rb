...
test("[console] should work") do |page:|
...
test("[console] should work for Error instances") do |page:|
...
test("[console] should return the first line of the error message in text") do |page:|
  pending "Firefox BiDi log entries do not include Error message details for console args"
...
test("[console] should work on script call right after navigation") do |page:|
  message = wait_for_console_message(page) do
...
test("[console] should work for different console API calls with logging functions") do |page:|
...
test("[console] should work for different console API calls with timing functions") do |page:|
...
test("[console] should work for different console API calls with group functions") do |page:|
...
test("[console] should not fail for window object") do |page:|
  message = wait_for_console_message(page) do
...
test("[console] should return remote objects") do |page:|
...
test("[console] should trigger correct Log") do |page:, server:|
...
test("[console] should have location when fetch fails") do |page:, server:|
...
test("[console] should have location and stack trace for console API calls") do |page:, server:|
  page.goto(server.empty_page)
