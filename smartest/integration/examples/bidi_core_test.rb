require "test_helper"
  ...
  test(['Core BiDi implementation', 'basic usage with core classes'].join(" ")) do
  ...
  test(['Core BiDi implementation', 'event handling'].join(" ")) do
  ...
  test(['Core BiDi implementation', 'multiple contexts'].join(" ")) do
  ...
  test(['Core BiDi implementation', 'user context isolation'].join(" ")) do
