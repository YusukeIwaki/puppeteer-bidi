...
require "test_helper"
  ...
  def permission_state(page, name)
    ...
    test(['BrowserContext', 'BrowserContext.new_page', 'should create a background page'].join(" ")) do |context:|
      page = nil
      begin
    ...
    test(['BrowserContext', 'BrowserContext.set_permission', 'should set permission state for an origin'].join(" ")) do |page:, context:, server:|
    ...
    test(['BrowserContext', 'BrowserContext.set_permission', 'should reject wildcard origin'].join(" ")) do |context:|
      expect {
    ...
    test(['BrowserContext', 'BrowserContext.set_permission', 'should support multiple permissions'].join(" ")) do |page:, context:, server:|
      page.goto(server.empty_page)
    ...
    test(['BrowserContext', 'Browser.set_permission', 'should set permission state in the default browser context'].join(" ")) do |page:, browser:, server:|
      page.goto(server.empty_page)
    ...
    test(['BrowserContext', 'BrowserContext.clear_permission_overrides', 'should reset override_permissions back to prompt'].join(" ")) do |page:, context:, server:|
      page.goto(server.empty_page)
      expect(permission_state(page, 'geolocation')).to eq('prompt')
